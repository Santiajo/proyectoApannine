    ...
    <div class="separacionFormulario">
        ...
        <div class="layoutNombre">
            <div>
                ...
                <input type="text" name="userPNombre" id="userPNombre" value="{{ old('userPNombre', $usuario->primer_nombre ?? '') }}">
            </div>
            <div>
                <label for="userSNombre">Segundo Nombre:</label>
                <input type="text" name="userSNombre" id="userSNombre" value="{{ old('userSNombre', $usuario->segundo_nombre ?? '') }}">
            </div>
            <div>
                <label for="userApPaterno">Apellido Paterno:</label>
                <input type="text" name="userApPaterno" id="userApPaterno" value="{{ old('userApPaterno', $usuario->apellido_paterno ?? '') }}">
            </div>
            <div>
                <label for="userApMaterno">Apellido Materno:</label>
                <input type="text" name="userApMaterno" id="userApMaterno" value="{{ old('userApMaterno', $usuario->apellido_materno ?? '') }}">
            </div>
        </div>

        <!-- Teléfono -->
        <label for="userTel">Teléfono:</label>
        <input type="tel" name="userTel" id="userTel" value="{{ old('userTel', $usuario->telefono ?? '') }}">

        <!-- Correo usuario -->
        <label for="userEmail">Correo electrónico:</label>
        <input type="email" name="userEmail" id="userEmail" value="{{ old('userEmail', $usuario->email ?? '') }}">

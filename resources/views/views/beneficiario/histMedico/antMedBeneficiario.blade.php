    ...
    <div class="content">
        ...
        <div class="fila1 fila1Perso" id="apartadoDocumentos">
            ...
            <table>
                ...
                <tbody>
                    @if ($antSal->documentos->isEmpty())
                        <tr>
                            <td colspan="4">No hay documentos subidos!</td>
                        </tr>
                    @else
                        @foreach ($antSal->documentos as $documento)
                            <tr>
                                <td data-label="Documentos">{{ $documento->antSalFilePath }}</td>
                                <td data-label="Fecha de subida">{{ $documento->created_at }}</td>
                                <td data-label="Descargar">
                                    <a class="detalles" href="{{ asset('storage/' . $documento->antSalFilePath) }}" target="_blank">
